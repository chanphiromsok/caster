 ...
 */
const BUNDLE_ID = "com.three.podcast"; // ios bundle id
const PACKAGE = "com.three.podcast"; // android package name
const NAME = "Caster"; // app name
const SCHEME = "Caster"; // app scheme
